...
public class CommenUtils {
    ...
    public static void hideKeyboard(Activity activity) {
        ...
        if (focus != null) {
            ...
            inputManager.hideSoftInputFromWindow(focus.getWindowToken(), InputMethodManager
                    .HIDE_NOT_ALWAYS);
        }
    }
    ...
    public static void showConfirmDialog(Context context, CharSequence title, CharSequence
			message, final Runnable okRun) {
