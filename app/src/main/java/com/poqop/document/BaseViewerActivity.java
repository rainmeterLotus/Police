...
public abstract class BaseViewerActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        documentView.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams
...
// .separator + "iTextTest"+File.separator+"aa.pdf");
//        Log.d("xx", Uri.fromFile(file).toString());
...
//        final MenuItem menuItem = menu.add(0, MENU_FULL_SCREEN, 0, "Full screen").setCheckable
// (true).setChecked(viewerPreferences.isFullScreen());
